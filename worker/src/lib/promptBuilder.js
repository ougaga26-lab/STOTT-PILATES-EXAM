...
4.嚴禁使用「一位學員正準備...」或「教練應該如何...」這種術語描述。
5.採用「學術陳述句」。例如：「關於凱迪拉克 (Cadillac) 推桿 (Push-thru Bar) 從高處向下移動時的安全設定，下列敘述何者正確？」
6.題目必須考驗：彈簧阻力方向、解剖學主動肌、或是器械標準操作程序。
7. 正確答案分布：A/B/C/D 均可為正確答案，確保均勻分布。`,
